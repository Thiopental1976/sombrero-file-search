# Linux File Search — Manual de uso
...
- **GUI** — `linux-file-search` (ou pelo menu, *Linux File Search*).
...
*Linux File Search — software livre sob GNU GPL v3 ou posterior. Sem índice, sem
